package com.demo.demopdf.qrcode;
...
//            Code128Writer writer = new Code128Writer();
            ...
            BitMatrix bitMatrix = writer.encode(vaNumber, BarcodeFormat.CODABAR, WIDTH, HEIGHT, hints);
...
//        A80/90R8A(8A侧通孔)
        BufferedImage image = insertWords(getBarCode("1322222"), "1322222");
        ImageIO.write(image, "jpg", new File("target/barcode.png"));
    }
